...
## Adding new clothes
- The procedure of adding new clothing to a custom character will require you to follow the steps seen in the [Palette API](palette.md) documentation, however there's some small adjustments needed.
...
- You're able to add **modded states** for your character/mod, this first requires creating the state enum that's going to be used. If you're unsure on how to do this, refer to [The Basics](pml.md) section of the documentation.
